...
create table tender(
    ...
    tenderTag int default 0 comment '标识自定义1 或爬取 0',
    userID nvarchar(100) comment '如果是自定义 记录创建者的ID'
);
...
(
    ...
    openid3 nvarchar(100) comment 'oa小程序的openid',
